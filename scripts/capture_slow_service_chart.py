...
def main():
    ...
    parser.add_argument("--crop-width", type=int, default=1354, help="裁剪宽度")
    parser.add_argument("--crop-height", type=int, default=220, help="裁剪高度")
    parser.add_argument("--crop-x", type=int, default=15, help="裁剪 X 偏移")
    parser.add_argument("--crop-y", type=int, default=266, help="裁剪 Y 偏移")
